...
namespace HLApps.Revit.Geometry.Octree
{
    ...
    { 
        ...
        public PointOctree(float initialWorldSize, XYZ initialWorldPos, float minNodeSize)
        {
        ...
        public void Add(T obj, XYZ objPos)
        {
        ...
        public T[] GetNearby(Line ray, float maxDistance)
        {
        ...
        public T[] GetNearby(XYZ point, float maxDistance)
        {
            List<T> collidingWith = new List<T>();
            rootNode.GetNearby(ref point, ref maxDistance, collidingWith);
            return collidingWith.ToArray();
        }
        /*
        /// <summary>
        ...
        void Grow(XYZ direction)
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                else
                {
                    ...
                    children[i] = new PointOctreeNode<T>(rootNode.SideLength, minSize, newCenter + new XYZ(xDirection * half, yDirection * half, zDirection * half));
                }
            }
